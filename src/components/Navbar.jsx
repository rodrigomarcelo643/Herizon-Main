...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="bg-[#F9F5F0] shadow-sm fixed w-full z-50 font-montserrat">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:flex items-center">
              <motion.button
                className="bg-[#E1D7CD] hover:bg-[#D0C4B8] px-8 text-gray-800 py-2 rounded-full text-sm font-bold"
